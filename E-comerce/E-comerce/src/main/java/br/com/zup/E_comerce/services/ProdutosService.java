...
public class ProdutosService {
    ...
    public ProdutosDTO cadastrarprodutos(ProdutosDTO produtosDTO) {
        //Validações
        //if (produtosDTO.getNomeproduto() == unique){}
...
// Atualizar produto
    public ProdutosDTO atualizarProduto(Long id, ProdutosDTO produtosDTO) {
        ...
        if (produtoOptional.isPresent()){
            ...
            return new ProdutosDTO(produtoAtualizado.getNomeproduto(),produtoAtualizado.getPrecoproduto(),produtoAtualizado.getQuantidade(),produtoAtualizado.getId());
        }else {
